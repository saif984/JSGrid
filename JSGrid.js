...
JSGrid.prototype.GenerateExtraFooter = function () {
    ...
    if (ExtraFooterFlag)
        return `<tr><td><table cellpadding='0' cellspacing='0' style='table-layout:fixed;'><colgroup id='${this.Grid.id}_ExtraFooter'>${CellCols}</colgroup>${ExtraFooter}</table></td></tr>`;
    else
        return ""
}
